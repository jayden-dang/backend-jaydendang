...
pub struct CreateUserProfileRequest {
  ...
  #[validate(range(min = 1900, max = 2024, message = "Birth year must be between 1900 and 2024"))]
  ...
  #[validate(length(min = 2, max = 10, message = "Language preference must be 2-10 characters"))]
